...
Shader "BOXOPHOBIC/The Vegetation Engine/Vegetation/Bark Standard Detail Lit"
{
	Properties
	{
		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 appendResult21_g52242 = (float2(v.uv1.x , v.uv1.y));
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				half Mask_Detail147_g51941 = saturate(lerpResult4058_g51941);
