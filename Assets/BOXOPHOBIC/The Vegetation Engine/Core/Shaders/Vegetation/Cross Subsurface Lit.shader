		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 PositionOS3588_g51724 = v.vertex.xyz;
				half3 _Vector1 = half3(0,0,0);
				half3 Mesh_PivotsOS2291_g51724 = _Vector1;
				float3 temp_output_2283_0_g51724 = ( PositionOS3588_g51724 - Mesh_PivotsOS2291_g51724 );
				half3 VertexPos40_g52260 = temp_output_2283_0_g51724;
				...
				float Bounds_Height374_g51724 = _MaxBoundsInfo.y;
				float WorldData19_g52309 = ( Bounds_Height374_g51724 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g52309 = WorldData19_g52309;
				#else
				float staticSwitch14_g52309 = ObjectData20_g52309;
				#endif
				float Motion_Max_Bending1133_g51724 = staticSwitch14_g52309;
				...
				half4 Global_Motion_Params3909_g51724 = lerpResult87_g52277;
				float4 break322_g52303 = Global_Motion_Params3909_g51724;
				half Wind_Power369_g52303 = break322_g52303.z;
				float lerpResult376_g52303 = lerp( 0.1 , 1.0 , Wind_Power369_g52303);
				half Wind_Power_103106_g51724 = lerpResult376_g52303;
				...
				half2 Wind_DirectionOS39_g51724 = (temp_output_339_0_g52303).xz;
				...
				half Wind_Power2223_g51724 = Wind_Power369_g52303;
				float temp_output_167_0_g52296 = Wind_Power2223_g51724;
				...
				half Global_NoiseTex_R34_g51724 = break142_g52296.r;
				...
				#endif
				half Motion_Variation3073_g51724 = staticSwitch14_g52213;
				half Motion_Variation284_g52219 = ( _MotionVariation_10 * Motion_Variation3073_g51724 );
				...
				half Input_Turbulence327_g52219 = Global_NoiseTex_R34_g51724;
				float2 lerpResult321_g52219 = lerp( Sine_MinusOneToOne281_g52219 , temp_cast_12 , Input_Turbulence327_g52219);
				half2 Motion_Bending2258_g51724 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g51724 ) * Wind_Power_103106_g51724 * Wind_DirectionOS39_g51724 * Global_NoiseTex_R34_g51724 * lerpResult321_g52219 );
				half Interaction_Amplitude4137_g51724 = _InteractionAmplitude;
				...
				half4 Global_React_Params4173_g51724 = lerpResult87_g52269;
				float4 break322_g52256 = Global_React_Params4173_g51724;
				half Interaction_Mask66_g51724 = break322_g52256.z;
				...
				half2 Interaction_DirectionOS4158_g51724 = (temp_output_339_0_g52256).xz;
				float lerpResult3307_g51724 = lerp( 1.0 , Motion_Variation3073_g51724 , _InteractionVariation);
				half2 Motion_Interaction53_g51724 = ( Interaction_Amplitude4137_g51724 * Motion_Max_Bending1133_g51724 * Interaction_Mask66_g51724 * Interaction_Mask66_g51724 * Interaction_DirectionOS4158_g51724 * lerpResult3307_g51724 );
				float2 lerpResult109_g51724 = lerp( Motion_Bending2258_g51724 , Motion_Interaction53_g51724 , ( Interaction_Mask66_g51724 * saturate( Interaction_Amplitude4137_g51724 ) ));
				half Mesh_Motion_182_g51724 = v.ase_texcoord3.x;
				float2 break143_g51724 = ( lerpResult109_g51724 * Mesh_Motion_182_g51724 );
				half Motion_Z190_g51724 = break143_g51724.y;
				half Angle44_g52260 = Motion_Z190_g51724;
				...
				half Motion_X216_g51724 = break143_g51724.x;
				half Angle44_g52259 = -Motion_X216_g51724;
				float3 Vertex_Motion_Object833_g51724 = ( VertexPosRotationAxis50_g52259 + ( VertexPosOtherAxis82_g52259 * cos( Angle44_g52259 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g52259 ) * sin( Angle44_g52259 ) ) );
				float3 temp_output_3474_0_g51724 = ( PositionOS3588_g51724 - Mesh_PivotsOS2291_g51724 );
				float3 appendResult2043_g51724 = (float3(Motion_X216_g51724 , 0.0 , Motion_Z190_g51724));
				float3 Vertex_Motion_World1118_g51724 = ( temp_output_3474_0_g51724 + appendResult2043_g51724 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float3 staticSwitch3312_g51724 = Vertex_Motion_World1118_g51724;
				#else
				float3 staticSwitch3312_g51724 = ( Vertex_Motion_Object833_g51724 + ( 0.0 * _VertexDataMode ) );
				#endif
				half Global_Vertex_Size174_g51724 = break322_g52256.w;
				float lerpResult346_g51724 = lerp( 1.0 , Global_Vertex_Size174_g51724 , _GlobalSize);
				float3 appendResult3480_g51724 = (float3(lerpResult346_g51724 , lerpResult346_g51724 , lerpResult346_g51724));
				half3 ObjectData20_g52294 = appendResult3480_g51724;
				...
				#endif
				half3 Vertex_Size1741_g51724 = staticSwitch14_g52294;
				half3 _Vector5 = half3(1,1,1);
				float3 Vertex_SizeFade1740_g51724 = _Vector5;
				half3 Grass_Coverage2661_g51724 = half3(0,0,0);
				float3 Final_VertexPosition890_g51724 = ( ( staticSwitch3312_g51724 * Vertex_Size1741_g51724 * Vertex_SizeFade1740_g51724 ) + Mesh_PivotsOS2291_g51724 + Grass_Coverage2661_g51724 );
				
				float temp_output_7_0_g52211 = _GradientMinValue;
				float4 lerpResult2779_g51724 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( v.ase_color.a - temp_output_7_0_g52211 ) / ( _GradientMaxValue - temp_output_7_0_g52211 ) ) ));
				half3 Gradient_Tint2784_g51724 = (lerpResult2779_g51724).rgb;
				float3 vertexToFrag11_g52235 = Gradient_Tint2784_g51724;
				o.ase_texcoord7.xyz = vertexToFrag11_g52235;
				float3 temp_cast_20 = (_NoiseScaleValue).xxx;
				float3 vertexToFrag3890_g51724 = ase_worldPos;
				float3 PositionWS_PerVertex3905_g51724 = vertexToFrag3890_g51724;
				float temp_output_7_0_g52236 = _NoiseMinValue;
				half Noise_Mask3162_g51724 = saturate( ( ( SAMPLE_TEXTURE3D_LOD( TVE_WorldTex3D, samplerTVE_WorldTex3D, ( temp_cast_20 * PositionWS_PerVertex3905_g51724 * 0.1 ), 0.0 ).r - temp_output_7_0_g52236 ) / ( _NoiseMaxValue - temp_output_7_0_g52236 ) ) );
				float4 lerpResult2800_g51724 = lerp( _NoiseColorTwo , _NoiseColorOne , Noise_Mask3162_g51724);
				half3 Noise_Tint2802_g51724 = (lerpResult2800_g51724).rgb;
				float3 vertexToFrag11_g52230 = Noise_Tint2802_g51724;
				o.ase_texcoord8.xyz = vertexToFrag11_g52230;
				float2 vertexToFrag11_g52308 = ( ( v.texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord9.xy = vertexToFrag11_g52308;
				float3 Position58_g52222 = PositionWS_PerVertex3905_g51724;
				...
				half Global_ColorsTex_A1701_g51724 = (lerpResult88_g52222).a;
				float vertexToFrag11_g52229 = Global_ColorsTex_A1701_g51724;
				o.ase_texcoord7.w = vertexToFrag11_g52229;
				o.ase_texcoord10.xyz = vertexToFrag3890_g51724;
				
				float2 vertexToFrag11_g52248 = ( ( v.texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				o.ase_texcoord9.zw = vertexToFrag11_g52248;
				...
				#endif
				float3 vertexValue = Final_VertexPosition890_g51724;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float2 vertexToFrag11_g52308 = IN.ase_texcoord9.xy;
				half2 Main_UVs15_g51724 = vertexToFrag11_g52308;
				float4 tex2DNode29_g51724 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g51724 );
				float3 temp_output_51_0_g51724 = ( (_MainColor).rgb * (tex2DNode29_g51724).rgb );
				half3 Main_Albedo99_g51724 = temp_output_51_0_g51724;
				half3 Blend_Albedo265_g51724 = Main_Albedo99_g51724;
				half3 Blend_AlbedoTinted2808_g51724 = ( vertexToFrag11_g52235 * vertexToFrag11_g52230 * float3(1,1,1) * Blend_Albedo265_g51724 );
				float dotResult3616_g51724 = dot( Blend_AlbedoTinted2808_g51724 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_0 = (dotResult3616_g51724).xxx;
				float vertexToFrag11_g52229 = IN.ase_texcoord7.w;
				half Global_Colors_Influence3668_g51724 = vertexToFrag11_g52229;
				float3 lerpResult3618_g51724 = lerp( Blend_AlbedoTinted2808_g51724 , temp_cast_0 , Global_Colors_Influence3668_g51724);
				float3 vertexToFrag3890_g51724 = IN.ase_texcoord10.xyz;
				float3 PositionWS_PerVertex3905_g51724 = vertexToFrag3890_g51724;
				float3 Position58_g52222 = PositionWS_PerVertex3905_g51724;
				float temp_output_82_0_g52222 = _LayerColorsValue;
				...
				half3 Global_ColorsTex_RGB1700_g51724 = (lerpResult88_g52222).rgb;
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g52206 = 2.0;
				#else
				float staticSwitch1_g52206 = 4.594794;
				#endif
				float3 temp_output_1953_0_g51724 = ( Global_ColorsTex_RGB1700_g51724 * staticSwitch1_g52206 );
				half3 Global_Colors1954_g51724 = temp_output_1953_0_g51724;
				half Global_Colors_Value3650_g51724 = _GlobalColors;
				float4 tex2DNode35_g51724 = SAMPLE_TEXTURE2D( _MainMaskTex, sampler_MainAlbedoTex, Main_UVs15_g51724 );
				half Main_Mask57_g51724 = tex2DNode35_g51724.b;
				float temp_output_7_0_g52233 = _ColorsMaskMinValue;
				half Global_Colors_Mask3692_g51724 = saturate( ( ( Main_Mask57_g51724 - temp_output_7_0_g52233 ) / ( _ColorsMaskMaxValue - temp_output_7_0_g52233 ) ) );
				float3 lerpResult3628_g51724 = lerp( Blend_AlbedoTinted2808_g51724 , ( lerpResult3618_g51724 * Global_Colors1954_g51724 ) , ( Global_Colors_Value3650_g51724 * Global_Colors_Mask3692_g51724 ));
				half3 Blend_AlbedoColored863_g51724 = lerpResult3628_g51724;
				float3 temp_output_799_0_g51724 = (_SubsurfaceColor).rgb;
				float dotResult3930_g51724 = dot( temp_output_799_0_g51724 , float3(0.2126,0.7152,0.0722) );
				float3 temp_cast_3 = (dotResult3930_g51724).xxx;
				float3 lerpResult3932_g51724 = lerp( temp_output_799_0_g51724 , temp_cast_3 , Global_Colors_Influence3668_g51724);
				float3 lerpResult3942_g51724 = lerp( temp_output_799_0_g51724 , ( lerpResult3932_g51724 * Global_Colors1954_g51724 ) , ( Global_Colors_Value3650_g51724 * Global_Colors_Mask3692_g51724 ));
				half3 Subsurface_Color1722_g51724 = lerpResult3942_g51724;
				half MainLight_Subsurface4041_g51724 = TVE_MainLightParams.a;
				half Subsurface_Intensity1752_g51724 = ( _SubsurfaceValue * MainLight_Subsurface4041_g51724 );
				float temp_output_7_0_g52237 = _SubsurfaceMaskMinValue;
				half Subsurface_Mask1557_g51724 = saturate( ( ( Main_Mask57_g51724 - temp_output_7_0_g52237 ) / ( _SubsurfaceMaskMaxValue - temp_output_7_0_g52237 ) ) );
				half3 Subsurface_Transmission884_g51724 = ( Subsurface_Color1722_g51724 * Subsurface_Intensity1752_g51724 * Subsurface_Mask1557_g51724 );
				half3 MainLight_Direction3926_g51724 = TVE_MainLightDirection;
				float3 normalizeResult2169_g51724 = normalize( ( _WorldSpaceCameraPos - WorldPosition ) );
				float3 ViewDir_Normalized3963_g51724 = normalizeResult2169_g51724;
				float dotResult785_g51724 = dot( -MainLight_Direction3926_g51724 , ViewDir_Normalized3963_g51724 );
				float saferPower1624_g51724 = max( (dotResult785_g51724*0.5 + 0.5) , 0.0001 );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1602_g51724 = 0.0;
				#else
				float staticSwitch1602_g51724 = ( pow( saferPower1624_g51724 , _MainLightAngleValue ) * _MainLightScatteringValue );
				#endif
				half Mask_Subsurface_View782_g51724 = staticSwitch1602_g51724;
				half3 Subsurface_Scattering1693_g51724 = ( Subsurface_Transmission884_g51724 * Blend_AlbedoColored863_g51724 * Mask_Subsurface_View782_g51724 );
				half3 Blend_AlbedoAndSubsurface149_g51724 = ( Blend_AlbedoColored863_g51724 + Subsurface_Scattering1693_g51724 );
				half3 Global_OverlayColor1758_g51724 = (TVE_OverlayColor).rgb;
				half Main_AlbedoTex_G3526_g51724 = tex2DNode29_g51724.g;
				float3 Position82_g52261 = PositionWS_PerVertex3905_g51724;
				...
				half Global_Extras_Overlay156_g51724 = break89_g52261.b;
				float temp_output_1025_0_g51724 = ( _GlobalOverlay * Global_Extras_Overlay156_g51724 );
				half Overlay_Commons1365_g51724 = temp_output_1025_0_g51724;
				float temp_output_7_0_g52234 = _OverlayMaskMinValue;
				half Overlay_Mask269_g51724 = saturate( ( ( ( ( 0.5 + Main_AlbedoTex_G3526_g51724 ) * Overlay_Commons1365_g51724 ) - temp_output_7_0_g52234 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g52234 ) ) );
				float3 lerpResult336_g51724 = lerp( Blend_AlbedoAndSubsurface149_g51724 , Global_OverlayColor1758_g51724 , Overlay_Mask269_g51724);
				half3 Final_Albedo359_g51724 = lerpResult336_g51724;
				
				float3 unpack4112_g51724 = UnpackNormalScale( SAMPLE_TEXTURE2D( _MainNormalTex, sampler_MainAlbedoTex, Main_UVs15_g51724 ), _MainNormalValue );
				unpack4112_g51724.z = lerp( 1, unpack4112_g51724.z, saturate(_MainNormalValue) );
				half3 Main_Normal137_g51724 = unpack4112_g51724;
				float3 temp_output_13_0_g52210 = Main_Normal137_g51724;
				float3 switchResult12_g52210 = (((ase_vface>0)?(temp_output_13_0_g52210):(( temp_output_13_0_g52210 * _render_normals_options ))));
				half3 Blend_Normal312_g51724 = switchResult12_g52210;
				half3 Final_Normal366_g51724 = Blend_Normal312_g51724;
				
				float2 vertexToFrag11_g52248 = IN.ase_texcoord9.zw;
				half2 Emissive_UVs2468_g51724 = vertexToFrag11_g52248;
				half Global_Extras_Emissive4203_g51724 = break89_g52261.r;
				float lerpResult4206_g51724 = lerp( 1.0 , Global_Extras_Emissive4203_g51724 , _GlobalEmissive);
				half3 Final_Emissive2476_g51724 = ( (( _EmissiveColor * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g51724 ) )).rgb * lerpResult4206_g51724 );
				
				float3 temp_cast_7 = (( 0.04 * _RenderSpecular )).xxx;
				
				half Main_Smoothness227_g51724 = ( tex2DNode35_g51724.a * _MainSmoothnessValue );
				half Blend_Smoothness314_g51724 = Main_Smoothness227_g51724;
				half Global_OverlaySmoothness311_g51724 = TVE_OverlaySmoothness;
				float lerpResult343_g51724 = lerp( Blend_Smoothness314_g51724 , Global_OverlaySmoothness311_g51724 , Overlay_Mask269_g51724);
				half Final_Smoothness371_g51724 = lerpResult343_g51724;
				half Global_Extras_Wetness305_g51724 = break89_g52261.g;
				float lerpResult3673_g51724 = lerp( 0.0 , Global_Extras_Wetness305_g51724 , _GlobalWetness);
				half Final_SmoothnessAndWetness4130_g51724 = saturate( ( Final_Smoothness371_g51724 + lerpResult3673_g51724 ) );
				
				float lerpResult240_g51724 = lerp( 1.0 , tex2DNode35_g51724.g , _MainOcclusionValue);
				half Main_Occlusion247_g51724 = lerpResult240_g51724;
				half Blend_Occlusion323_g51724 = Main_Occlusion247_g51724;
				
				float localCustomAlphaClip3735_g51724 = ( 0.0 );
				float3 normalizeResult3971_g51724 = normalize( cross( ddy( WorldPosition ) , ddx( WorldPosition ) ) );
				float3 NormalsWS_Derivates3972_g51724 = normalizeResult3971_g51724;
				float dotResult2161_g51724 = dot( ViewDir_Normalized3963_g51724 , NormalsWS_Derivates3972_g51724 );
				float dotResult2212_g51724 = dot( ViewDir_Normalized3963_g51724 , float3(0,1,0) );
				half Mask_HView2656_g51724 = dotResult2212_g51724;
				float lerpResult2221_g51724 = lerp( _FadeHorizontalValue , _FadeVerticalValue , Mask_HView2656_g51724);
				float lerpResult3992_g51724 = lerp( 1.0 , abs( dotResult2161_g51724 ) , lerpResult2221_g51724);
				half Fade_Billboard2175_g51724 = lerpResult3992_g51724;
				half Final_AlphaFade3727_g51724 = ( 1.0 * Fade_Billboard2175_g51724 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g51724;
				float Main_Alpha316_g51724 = ( _MainColor.a * tex2DNode29_g51724.a );
				half AlphaTreshold2132_g51724 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g51724 = ( Main_Alpha316_g51724 - ( AlphaTreshold2132_g51724 - 0.5 ) );
				#else
				float staticSwitch3792_g51724 = Main_Alpha316_g51724;
				#endif
				half Final_Alpha3754_g51724 = staticSwitch3792_g51724;
				float temp_output_661_0_g51724 = ( saturate( ( temp_output_41_0_g52255 + ( temp_output_41_0_g52255 * SAMPLE_TEXTURE3D( TVE_ScreenTex3D, samplerTVE_ScreenTex3D, ( TVE_ScreenTexCoord * PositionWS_PerVertex3905_g51724 ) ).r ) ) ) * Final_Alpha3754_g51724 );
				float Alpha3735_g51724 = temp_output_661_0_g51724;
				float Treshold3735_g51724 = 0.5;
				{
				#if TVE_ALPHA_CLIP
				clip(Alpha3735_g51724 - Treshold3735_g51724);
				#endif
				}
				half Final_Clip914_g51724 = saturate( Alpha3735_g51724 );
				
				float3 Albedo = Final_Albedo359_g51724;
				float3 Normal = Final_Normal366_g51724;
				float3 Emission = Final_Emissive2476_g51724;
				float3 Specular = temp_cast_7;
				float Metallic = 0;
				float Smoothness = Final_SmoothnessAndWetness4130_g51724;
				float Occlusion = Blend_Occlusion323_g51724;
				float Alpha = Final_Clip914_g51724;
				float AlphaClipThreshold = 0.5;
				float AlphaClipThresholdShadow = 0.5;
				float3 BakedGI = 0;
				float3 RefractionColor = 1;
				float RefractionIndex = 1;
				float3 Transmission = Subsurface_Transmission884_g51724;
		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float3 vertexToFrag3890_g51724 = ase_worldPos;
				o.ase_texcoord2.xyz = vertexToFrag3890_g51724;
						 ...
						 ) : SV_TARGET
			{
				...
				half Final_AlphaFade3727_g51724 = ( 1.0 * Fade_Billboard2175_g51724 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g51724;
				float3 vertexToFrag3890_g51724 = IN.ase_texcoord2.xyz;
				float3 PositionWS_PerVertex3905_g51724 = vertexToFrag3890_g51724;
		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord5.xyz = vertexToFrag3890_g51724;
				
				float2 vertexToFrag11_g52248 = ( ( v.ase_texcoord.xy * (_EmissiveUVs).xy ) + (_EmissiveUVs).zw );
				o.ase_texcoord4.zw = vertexToFrag11_g52248;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half Global_Colors_Influence3668_g51724 = vertexToFrag11_g52229;
				float3 lerpResult3618_g51724 = lerp( Blend_AlbedoTinted2808_g51724 , temp_cast_0 , Global_Colors_Influence3668_g51724);
				float3 vertexToFrag3890_g51724 = IN.ase_texcoord5.xyz;
				float3 PositionWS_PerVertex3905_g51724 = vertexToFrag3890_g51724;
				float3 Position58_g52222 = PositionWS_PerVertex3905_g51724;
				float temp_output_82_0_g52222 = _LayerColorsValue;
				float4 lerpResult88_g52222 = lerp( TVE_ColorsParams , SAMPLE_TEXTURE2D_ARRAY( TVE_ColorsTex, samplerTVE_ColorsTex, ( (TVE_ColorsCoord).zw + ( (TVE_ColorsCoord).xy * (Position58_g52222).xz ) ),temp_output_82_0_g52222 ) , TVE_ColorsUsage[(int)temp_output_82_0_g52222]);
				...
				float2 vertexToFrag11_g52248 = IN.ase_texcoord4.zw;
				half2 Emissive_UVs2468_g51724 = vertexToFrag11_g52248;
				half Global_Extras_Emissive4203_g51724 = break89_g52261.r;
				float lerpResult4206_g51724 = lerp( 1.0 , Global_Extras_Emissive4203_g51724 , _GlobalEmissive);
				half3 Final_Emissive2476_g51724 = ( (( _EmissiveColor * SAMPLE_TEXTURE2D( _EmissiveTex, sampler_EmissiveTex, Emissive_UVs2468_g51724 ) )).rgb * lerpResult4206_g51724 );
		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 vertexToFrag3890_g51724 = ase_worldPos;
				o.ase_texcoord3.xyz = vertexToFrag3890_g51724;
				float2 vertexToFrag11_g52308 = ( ( v.ase_texcoord.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				o.ase_texcoord4.xy = vertexToFrag11_g52308;
						 ...
						 ) : SV_TARGET
			{
				...
				half Final_AlphaFade3727_g51724 = ( 1.0 * Fade_Billboard2175_g51724 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g51724;
				float3 vertexToFrag3890_g51724 = IN.ase_texcoord3.xyz;
				float3 PositionWS_PerVertex3905_g51724 = vertexToFrag3890_g51724;
				float2 vertexToFrag11_g52308 = IN.ase_texcoord4.xy;
				half2 Main_UVs15_g51724 = vertexToFrag11_g52308;
				float4 tex2DNode29_g51724 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g51724 );
...
/*ASEBEGIN
Version=18910
1920;0;1920;1029;2894.524;693.799;1.01798;True;False
...
Node;AmplifyShaderEditor.FunctionNode;397;-1344,-896;Inherit;False;Compile All Shaders;-1;;52310;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;354;-2176,384;Inherit;False;Define TVE IS VEGETATION SHADER;-1;;51722;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=231979180B52C3F9EF47359801346C3371C48C88
