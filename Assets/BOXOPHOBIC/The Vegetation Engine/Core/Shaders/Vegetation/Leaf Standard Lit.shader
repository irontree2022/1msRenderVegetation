		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float Motion_Variation330_g52247 = ( _MotionVariation_32 * Motion_Variation3073_g51941 );
				half Input_Amplitude58_g52247 = ( _MotionAmplitude_32 * Bounds_Radius121_g51941 * 0.1 );
				...
				#endif
				half Global_NoiseTex_A139_g51941 = break142_g52296.a;
				half Mesh_Motion_3144_g51941 = v.ase_texcoord3.z;
				float lerpResult378_g52303 = lerp( 0.3 , 1.0 , Wind_Power369_g52303);
				half Wind_Power_323115_g51941 = lerpResult378_g52303;
				float temp_output_7_0_g52254 = TVE_MotionFadeEnd;
				half Wind_FadeOut4005_g51941 = saturate( ( ( distance( ase_worldPos , _WorldSpaceCameraPos ) - temp_output_7_0_g52254 ) / ( TVE_MotionFadeStart - temp_output_7_0_g52254 ) ) );
				half3 Motion_Detail263_g51941 = ( staticSwitch358_g52247 * ( ( Global_NoiseTex_R34_g51941 + Global_NoiseTex_A139_g51941 ) * Mesh_Motion_3144_g51941 * Wind_Power_323115_g51941 ) * Wind_FadeOut4005_g51941 );
				float3 Vertex_Motion_Object833_g51941 = ( ( VertexPosRotationAxis50_g52259 + ( VertexPosOtherAxis82_g52259 * cos( Angle44_g52259 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g52259 ) * sin( Angle44_g52259 ) ) ) + Motion_Detail263_g51941 );
				...
				float3 Vertex_Motion_World1118_g51941 = ( ( ( temp_output_3474_0_g51941 + appendResult2047_g51941 ) + appendResult2043_g51941 ) + Motion_Detail263_g51941 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				...
				o.ase_texcoord8.w = vertexToFrag11_g52251;
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float lerpResult3870_g51941 = lerp( 1.0 , IN.ase_color.r , _ColorsVariationValue);
				half Global_Colors_Value3650_g51941 = ( _GlobalColors * lerpResult3870_g51941 );
				...
				float dotResult777_g51941 = dot( MainLight_Direction3926_g51941 , Main_Normal_WS4101_g51941 );
				float lerpResult4198_g51941 = lerp( 1.0 , saturate( dotResult777_g51941 ) , _MainLightNormalValue);
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1604_g51941 = 0.0;
				#else
				float staticSwitch1604_g51941 = lerpResult4198_g51941;
				#endif
				half Mask_Subsurface_Normal870_g51941 = staticSwitch1604_g51941;
				half3 Subsurface_Scattering1693_g51941 = ( Subsurface_Transmission884_g51941 * Blend_AlbedoColored863_g51941 * Mask_Subsurface_View782_g51941 * Mask_Subsurface_Normal870_g51941 );
				...
				float lerpResult1065_g51941 = lerp( 1.0 , IN.ase_color.r , _OverlayVariationValue);
				half Overlay_Commons1365_g51941 = ( temp_output_1025_0_g51941 * lerpResult1065_g51941 );
				float temp_output_7_0_g52234 = _OverlayMaskMinValue;
				half Overlay_Mask269_g51941 = saturate( ( ( ( ( ( lerpResult3567_g51941 * 0.5 ) + Main_AlbedoTex_G3526_g51941 ) * Overlay_Commons1365_g51941 ) - temp_output_7_0_g52234 ) / ( _OverlayMaskMaxValue - temp_output_7_0_g52234 ) ) );
				...
				float3 lerpResult2945_g51941 = lerp( (_VertexOcclusionColor).rgb , temp_cast_7 , saturate( ( ( Mesh_Occlusion318_g51941 - temp_output_7_0_g52232 ) / ( _VertexOcclusionMaxValue - temp_output_7_0_g52232 ) ) ));
				...
				float dotResult3851_g51941 = dot( ViewDir_Normalized3963_g51941 , NormalsWS_Derivates3972_g51941 );
				float lerpResult3993_g51941 = lerp( 1.0 , abs( dotResult3851_g51941 ) , _FadeGlancingValue);
				half Fade_Glancing3853_g51941 = lerpResult3993_g51941;
				float vertexToFrag11_g52251 = IN.ase_texcoord8.w;
				half Fade_Camera3743_g51941 = vertexToFrag11_g52251;
				half Final_AlphaFade3727_g51941 = ( Fade_Glancing3853_g51941 * Fade_Camera3743_g51941 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g51941;
				float Main_Alpha316_g51941 = ( _MainColor.a * tex2DNode29_g51941.a );
				float Mesh_Variation16_g51941 = IN.ase_color.r;
				float temp_output_4023_0_g51941 = (Mesh_Variation16_g51941*0.5 + 0.5);
				half Global_Extras_Alpha1033_g51941 = break89_g52261.a;
				float temp_output_4022_0_g51941 = ( temp_output_4023_0_g51941 - ( 1.0 - Global_Extras_Alpha1033_g51941 ) );
				half AlphaTreshold2132_g51941 = _Cutoff;
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch4017_g51941 = ( temp_output_4022_0_g51941 + AlphaTreshold2132_g51941 );
				#else
				float staticSwitch4017_g51941 = temp_output_4022_0_g51941;
				#endif
				float lerpResult4011_g51941 = lerp( 1.0 , staticSwitch4017_g51941 , _GlobalAlpha);
				half Global_Alpha315_g51941 = saturate( lerpResult4011_g51941 );
				#ifdef TVE_ALPHA_CLIP
				float staticSwitch3792_g51941 = ( ( Main_Alpha316_g51941 * Global_Alpha315_g51941 ) - ( AlphaTreshold2132_g51941 - 0.5 ) );
				#else
				float staticSwitch3792_g51941 = ( Main_Alpha316_g51941 * Global_Alpha315_g51941 );
				#endif
		...
		Pass
		{
           ...
           #pragma multi_compile GPU_FRUSTUM_ON __
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float temp_output_3976_0_g51941 = pow( saferPower3976_g51941 , _FadeCameraValue );
				float vertexToFrag11_g52251 = temp_output_3976_0_g51941;
				o.ase_texcoord3.w = vertexToFrag11_g52251;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float lerpResult3993_g51941 = lerp( 1.0 , abs( dotResult3851_g51941 ) , _FadeGlancingValue);
				half Fade_Glancing3853_g51941 = lerpResult3993_g51941;
				float vertexToFrag11_g52251 = IN.ase_texcoord3.w;
				half Fade_Camera3743_g51941 = vertexToFrag11_g52251;
				half Final_AlphaFade3727_g51941 = ( Fade_Glancing3853_g51941 * Fade_Camera3743_g51941 );
				float temp_output_41_0_g52255 = Final_AlphaFade3727_g51941;
				float Main_Alpha316_g51941 = ( _MainColor.a * tex2DNode29_g51941.a );
...
/*ASEBEGIN
Version=18910
1920;0;1920;1029;2732.684;864.5909;1;True;False
Node;AmplifyShaderEditor.FunctionNode;610;-2176,384;Inherit;False;Define TVE IS VEGETATION SHADER;-1;;40293;b458122dd75182d488380bd0f592b9e6;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;652;-1344,-896;Inherit;False;Compile All Shaders;-1;;51939;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;651;-1856,384;Inherit;False;Define PIPELINE UNIVERSAL;-1;;51938;71dc7add32e5f6247b1fb74ecceddd3e;0;0;1;FLOAT;529
...
ASEEND*/
//CHKSM=F5ABC104943A0B82B0B5005EB818C4E19F0179A1
