...
Shader "BOXOPHOBIC/The Vegetation Engine/Elements/Default/Extras Emissive"
{
	Properties
	{
		...
		[StyledMessage(Info, Use the Emissive elements to dampen the emissive effect on vegetation or static props. Element Texture R is used as alpha mask. Particle Color R is used as values multiplier and Alpha as Element Intensity multiplier., 0,0)]_Message("Message", Float) = 0
	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half Base_Extras_RGB213_g19342 = ( lerpResult181_g19342 * i.ase_color.r );
				half temp_output_9_0_g19346 = Base_Extras_RGB213_g19342;
				half sRGB8_g19346 = temp_output_9_0_g19346;
				half localGammaToLinearFloatFast8_g19346 = GammaToLinearFloatFast( sRGB8_g19346 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g19346 = temp_output_9_0_g19346;
				#else
				float staticSwitch1_g19346 = localGammaToLinearFloatFast8_g19346;
				#endif
				half3 appendResult890_g19342 = (half3(staticSwitch1_g19346 , 0.0 , 0.0));
				...
				half temp_output_7_0_g19355 = _MainTexMinValue;
				half4 temp_cast_0 = (temp_output_7_0_g19355).xxxx;
				half4 break469_g19342 = saturate( ( ( tex2DNode17_g19342 - temp_cast_0 ) / ( _MainTexMaxValue - temp_output_7_0_g19355 ) ) );
				half MainTex_R73_g19342 = break469_g19342.r;
				half4 Colors37_g19358 = TVE_ColorsCoord;
				half4 Extras37_g19358 = TVE_ExtrasCoord;
				half4 Motion37_g19358 = TVE_MotionCoord;
				half4 React37_g19358 = TVE_ReactCoord;
				half4 localIS_ELEMENT37_g19358 = IS_ELEMENT( Colors37_g19358 , Extras37_g19358 , Motion37_g19358 , React37_g19358 );
				half4 temp_output_35_0_g19352 = localIS_ELEMENT37_g19358;
				half temp_output_7_0_g19357 = TVE_ElementsFadeValue;
				half2 temp_cast_1 = (temp_output_7_0_g19357).xx;
				half2 temp_output_851_0_g19342 = saturate( ( ( abs( (( (temp_output_35_0_g19352).zw + ( (temp_output_35_0_g19352).xy * (WorldPosition).xz ) )*2.0 + -1.0) ) - temp_cast_1 ) / ( 1.0 - temp_output_7_0_g19357 ) ) );
				half2 break852_g19342 = ( temp_output_851_0_g19342 * temp_output_851_0_g19342 );
				half Enable_Fade_Support454_g19342 = _ElementFadeSupport;
				half lerpResult842_g19342 = lerp( 1.0 , ( 1.0 - saturate( ( break852_g19342.x + break852_g19342.y ) ) ) , Enable_Fade_Support454_g19342);
				half FadeOut_Mask656_g19342 = lerpResult842_g19342;
				half Element_Intensity56_g19342 = ( _ElementIntensity * i.ase_color.a * FadeOut_Mask656_g19342 );
				half Final_Emissive_A884_g19342 = ( MainTex_R73_g19342 * Element_Intensity56_g19342 );
...
/*ASEBEGIN
Version=18909
1920;0;1920;1029;1658.536;1759.973;1;True;False
Node;AmplifyShaderEditor.FunctionNode;113;-640,-1408;Inherit;False;Define ELEMENT EXTRAS;47;;19324;adca672cb6779794dba5f669b4c5f8e3;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;111;-256,-1408;Half;False;Property;_Message;Message;1;0;Create;True;0;0;0;True;1;StyledMessage(Info, Use the Emissive elements to dampen the emissive effect on vegetation or static props. Element Texture R is used as alpha mask. Particle Color R is used as values multiplier and Alpha as Element Intensity multiplier., 0,0);False;0;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;-304,-1152;Half;False;True;-1;2;TVEShaderElementGUI;0;1;BOXOPHOBIC/The Vegetation Engine/Elements/Default/Extras Emissive;0770190933193b94aaa3065e307002fa;True;Unlit;0;0;Unlit;2;False;True;2;5;False;-1;10;False;-1;0;1;False;-1;0;False;-1;True;0;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;True;True;True;False;False;False;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;0;False;-1;True;False;0;False;-1;0;False;-1;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;PreviewType=Plane;True;0;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;1;True;False;;False;0
WireConnection;0;0;118;0
ASEEND*/
//CHKSM=23817418283E687AE98AE658592D3F78510DB4E2